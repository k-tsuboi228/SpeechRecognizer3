...
public final class HttpGetTask2 extends AsyncTask<String, Void, String> {

    private ArrayList<String> translateText;
    private Context mContext;

    public HttpGetTask2(ArrayList<String> translateText, Context context){
        super();
    ...
    protected void onPostExecute(String result){
        ...
        try{
            ...
            if(translatedText != ""){
                ...
                Toast.makeText(mContext,"イタリア語の翻訳に失敗しました",Toast.LENGTH_SHORT).show();
            }
