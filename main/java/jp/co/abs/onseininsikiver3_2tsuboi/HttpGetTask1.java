...
public final class HttpGetTask1 extends AsyncTask<String, Void, String> {

    private ArrayList<String> translateText;
    private Context mContext;

    public HttpGetTask1(ArrayList<String> translateText, Context context){
        super();
    ...
    protected void onPostExecute(String result){
        ...
        try{
            ...
            if(translatedText != ""){
                ...
                Toast.makeText(mContext,"フランス語の翻訳に失敗しました",Toast.LENGTH_SHORT).show();
            }
